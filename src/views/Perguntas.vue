    ...
    <div class="card">
      <div class="card-body">
        ...
        <b-form>
          ...
          >
            <b-form-input id="input-1" v-model="form.pergunta" required placeholder="Nome pergunta"></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-3" label="Tipo:" label-for="input-3">
            <b-form-select id="input-3" v-model="form.tipo" :options="perguntasTipo" required></b-form-select>
          </b-form-group>

          <b-button variant="primary" @click="salvar">Criar</b-button>
          <b-button variant="danger" @click="form = {}">Limpar</b-button>
        </b-form>
      </div>
    </div>
